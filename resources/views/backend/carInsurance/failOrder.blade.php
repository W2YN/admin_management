...
@section('content')
    ...
    @include('backend.components.searchv2',  ['search' => $carInsuranceOrderPresenter->getFailOrderSearchParams()])
    <!-- 按钮栏 开始 -->
        ...
        @include('backend.components.tablev2',  ['table' => $carInsuranceOrderPresenter->getFailOrderTableParams()])
    </div>
@endsection