...
@section('content')
    <div class="page-container">
        @include('backend.components.searchv2',  ['search' => $carInsuranceOrderPresenter->getPendingOrderSearchParams()])
        ...
        @include('backend.components.tablev2',  ['table' => $carInsuranceOrderPresenter->getPendingOrderTableParams()])
