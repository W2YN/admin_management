...
@section('content')
    <div class="page-container">
        @include('backend.components.searchv2',  ['search' => $waterPurifierPresenter->getSearchParams()])
                <!-- 按钮栏 开始 -->
        ...
        @include('backend.components.tablev2',  ['table' => $waterPurifierPresenter->getTableParams()])
    </div>
@endsection
