        ...
        <form class="form form-horizontal" id="form-article-add">
            <div id="tab_demo" class="HuiTab">
                ...
                <div class="tabCon">
                    ...
                    <div class="mt-20">
                        <div class="row cl">
                            <label class="form-label col-xs-4 col-sm-2">模板消息ID：</label>
                    ...
                    <div class="mt-20">
                        <div class="row cl">
                            <label class="form-label col-xs-4 col-sm-2">发送信息：</label>
                            <div class="formControls col-xs-8 col-sm-9">
                                {{$data->errmsg}}
                            </div>
                        </div>
                    ...
                    <div class="mt-20">
                        <div class="row cl">
                            <label class="form-label col-xs-4 col-sm-2">是否延迟：</label>
                            <div class="formControls col-xs-8 col-sm-9">
                                {{ $wxplatformPresenter->showDelay($data['is_delay'])}}
                            </div>
                        </div>
                    </div>
                    <div class="mt-20">
