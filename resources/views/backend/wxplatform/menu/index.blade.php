...
@inject('wxplatformPresenter','App\Presenters\WxPlatformMenuPresenter')
@section('content')
...
@section('after.js')
    ...
    <script type="text/javascript">
        function synchronizeMenu() {
            ...
            $.ajax({
                type: 'get',
                url: '/backend/wechat/synchronizeMenu',
                dataType: 'json',
                success: function(data){
                    console.log(data.result);
                    if(data.result == 'ok'){
                        layer.msg('菜单更新成功',{icon:1,time:1000});
                    }
                    else{
                        layer.msg('菜单更新失败:'+data.result,{icon:2,time:9000});
                    }
